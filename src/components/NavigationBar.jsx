...
//                 </a>
//               ) : (
//                 <a href="/login" className="text-white text-lg font-semibold">
//                   AudibleBooks
//                 </a>
//               )}
//             </div>
...
import { NavLink, useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { logout, setUserProfile } from "../store/user/authSlice"; // Import setUserProfile
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import {
  faHome,
  faInfoCircle,
...
import { useGetCategoriesAPIQuery } from "../store/categories/categoryApiSlice";
import { useGetUserProfileAPIQuery } from "../store/user/userApiSlice"; // Import the API queries
import { useGetAuthorProfileAPIQuery } from "../store/user/authorApiSlice";
...
const NavigationBar = () => {
  ...
  useEffect(() => {
    if (profileData) {
      dispatch(setUserProfile(profileData)); // Dispatch the latest profile data
    }
