...
//         alert("Please login or authenticate to upload audiobooks.");
//         setSubmitting(false);
//         return;
//       }
...
//       //Access the authorId in JSON Object
//       const authorId = userData._id;
//       if (!authorId) {
//         console.error("Author ID not found in userData");
//         alert("Author ID not found. Please login or authenticate.");
//         setSubmitting(false);
//         return;
//       }
...
//                     <UploadIcon defaultSize={bookCover ? "contain" : "50px"}>
//                       <svg
...
//                     <UploadIcon defaultSize={bookAudio ? "contain" : "50px"}>
//                       <svg
//                         xmlns="http://www.w3.org/2000/svg"
//                         fill="none"
//                         viewBox="0 0 24 24"
...
//   svg {
//     width: ${(props) => props.defaultSize};
//     height: ${(props) => props.defaultSize};
//     color: #886ab5;
//   }
// `;
...
const UploadBooks = () => {
  ...
  //         // Access profileData from the JSON
  //         if (userData && userData.profileData && userData.profileData._id) {
  ...
  //           alert("Invalid user data structure. Please login again.");
  //           setSubmitting(false);
  //           return;
  //         }
  ...
  //       alert("Error parsing authentication data. Please login again.");
  //       setSubmitting(false);
  //       return;
  //     }
  //   } catch (err) {
      ...
      try {
        ...
        try {
          ...
          if (userData && userData.profileData && userData.profileData._id) {
            ...
            console.error("Invalid userData structure:", userData);
            toast.error("Invalid user data structure. Please login again.");
            setSubmitting(false);
            return;
          }
        } catch (userDataParseError) {
